...
from saicinpainting.training.trainers import make_training_model, make_4output_from_3output
...
# TODO: Change config_name to the .yaml file used
@handle_ddp_subprocess()
@hydra.main(config_path='../configs/training', config_name='lama-fourier-depth-4output-finetune.yaml')
def main(config: OmegaConf):
    ...
    try:
        ...
        training_model = make_4output_from_3output(config, checkpoint_path)
