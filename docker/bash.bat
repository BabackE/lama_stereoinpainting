...
--volume="D:\experiments\stereo\e113-lama-training-datasets\se01_bono_random_mask_training":/home/user/lama/tinydesk ^
...
-it --name="lama" --rm --shm-size=8gb --env="DISPLAY" experimental-lama /bin/bash
